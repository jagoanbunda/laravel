...
export default function PmtEdit({ schedule, children, menus }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        child_id: String(schedule.child_id),
        menu_id: String(schedule.menu_id),
    ...
    return (
        <AppLayout title="Edit PMT Schedule">
            <Head title="Edit PMT Schedule" />
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Edit PMT Schedule</h1>
                    <p className="text-muted-foreground">Update PMT distribution schedule</p>
                </div>
