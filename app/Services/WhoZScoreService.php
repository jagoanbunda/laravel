...
class WhoZScoreService
{
    ...
    /**
     * Menentukan status gizi berdasarkan Weight-for-Age Z-Score (BB/U).
     *
     * Berdasarkan Permenkes RI - Standar Antropometri Anak:
    ...
    /**
     * Menentukan status stunting berdasarkan Height-for-Age Z-Score (PB/U atau TB/U).
     *
     * Berdasarkan Permenkes RI - Standar Antropometri Anak:
    ...
    /**
     * Menentukan status wasting berdasarkan Weight-for-Height Z-Score (BB/PB atau BB/TB).
     *
     * Berdasarkan Permenkes RI - Standar Antropometri Anak:
     * - Gizi buruk (severely wasted): < -3 SD
     * - Gizi kurang (wasted): -3 SD s/d < -2 SD
     * - Gizi baik (normal): -2 SD s/d +1 SD
     * - Berisiko gizi lebih (risk overweight): > +1 SD s/d +2 SD
