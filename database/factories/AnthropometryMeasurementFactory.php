...
class AnthropometryMeasurementFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'nutritional_status' => fake()->randomElement(['normal', 'underweight', 'risk_overweight']),
            'stunting_status' => fake()->randomElement(['normal', 'stunted', 'tall']),
            'wasting_status' => fake()->randomElement(['normal', 'wasted', 'risk_overweight', 'overweight']),
